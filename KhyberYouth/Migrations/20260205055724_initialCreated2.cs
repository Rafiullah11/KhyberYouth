    ...
    public partial class initialCreated2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Media", "MediaGallery", "Explore our journey and see the impact we’re making together.", "fa-solid fa-music", "MEDIA" },
                    ...
                    { 3, "Donation", "Home", "Your donation brings hope and change. Support our mission by donating now.", "fa-solid fa-hand-holding-dollar", "SEND DONATION" }
                });
        }
